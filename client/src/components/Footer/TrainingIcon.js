...
export const TrainingIcon = () => {
    ...
    <svg enableBackground="new 0 0 64 64" height="50px" version="1.1" viewBox="0 0 64 64" width="50px"  xmlns="http://www.w3.org/2000/svg" >
    <g id="Layer_1"><g><circle cx="32" cy="32" fill="#C75C5C" r="32"/></g><g opacity="0.2">
